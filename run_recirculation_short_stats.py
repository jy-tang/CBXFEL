...
nEbeam_flat_init = 6  # number of ebeam shots
nEbeam_flat = 3
nEbeam_chirp = 5
beam_chirp = 27
...
if misalignQ:
    ...
    # short 400
    #M1 = 56079.86749154646
    #M2 = 24295.67278085632
    #M3 = -20860.34632822752
    #M4 = -21616.171219519667
...
for k in range(5, Nshot_total):
    ...
    jobid, sim_name = start_simulation(folder_name = folder_name, dKbyK = 0.006,undKs = 1.172,und_period = 0.026,und_nperiods=130, nslice = nslice, zsep = zsep,
                                           ...
                                           pulseLen = 80e-15, sigma = 20e-15, chirp = chirp, Ipeak = 2.0e3,
                                           xlamds = xlamds,
    ...
    jobid = start_recirculation_stats(zsep = zsep, ncar = ncar, dgrid = dgrid, nslice = nslice, xlamds=xlamds,           # dfl params
                                 ...
                                 l_undulator = 12*3.9, l_cavity = 49, w_cavity = 1, d1 = 100e-6, d2 = 100e-6, # cavity params
