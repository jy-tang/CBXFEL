...
nRoundtrips = 2          # number of iteration between ebeam shots
...
folder_name = 'data_3GeV_short_1MHz_3'
...
for k in range(7, Nshot_total):
    ...
    jobid, sim_name = start_simulation(folder_name = folder_name, dKbyK = 0.02,undKs = 0.477,und_period = 0.01,und_nperiods=int(130*0.026/0.01), nslice = nslice, zsep = zsep,
                                           nametag = nametag,gamma0 = np.around(3000./0.511,3), 
                                           Nf=1, Nt=11, emitnx = 0.3e-6, emitny = 0.3e-6,
                                           pulseLen = 100e-15, sigma = 20e-15, chirp = chirp, Ipeak = 2.0e3,
